...
public class BodyLockInterface extends NativeObject {
    ...
    public static void internal_native_deleteNative(long this_addr) {
        jolt.physics.body.natives.JNI_BodyLockInterface.internal_native_deleteNative(this_addr);
    }
    ...
    public static long internal_native_TryGetBody_addr(long this_addr, long inBodyID_addr) {
        return jolt.physics.body.natives.JNI_BodyLockInterface.internal_native_TryGetBody_addr(this_addr, inBodyID_addr);
    }
    ...
    public static long internal_native_LockRead_addr(long this_addr, long inBodyID_addr) {
        return jolt.physics.body.natives.JNI_BodyLockInterface.internal_native_LockRead_addr(this_addr, inBodyID_addr);
    }
    ...
    public static void internal_native_UnlockRead(long this_addr, long inMutex_addr) {
        jolt.physics.body.natives.JNI_BodyLockInterface.internal_native_UnlockRead(this_addr, inMutex_addr);
    }
    ...
    public static long internal_native_LockWrite_addr(long this_addr, long inBodyID_addr) {
        return jolt.physics.body.natives.JNI_BodyLockInterface.internal_native_LockWrite_addr(this_addr, inBodyID_addr);
    }
    ...
    public static void internal_native_UnlockWrite(long this_addr, long inMutex_addr) {
        jolt.physics.body.natives.JNI_BodyLockInterface.internal_native_UnlockWrite(this_addr, inMutex_addr);
    }
    ...
    public static long internal_native_GetMutexMask_addr(long this_addr, long inBodies_addr, int inNumber) {
        return jolt.physics.body.natives.JNI_BodyLockInterface.internal_native_GetMutexMask_addr(this_addr, inBodies_addr, inNumber);
    }
    ...
    public static void internal_native_LockRead__0(long this_addr, long inMutexMask_addr) {
        jolt.physics.body.natives.JNI_BodyLockInterface.internal_native_LockRead__0(this_addr, inMutexMask_addr);
    }
    ...
    public static void internal_native_UnlockRead__0(long this_addr, long inMutexMask_addr) {
        jolt.physics.body.natives.JNI_BodyLockInterface.internal_native_UnlockRead__0(this_addr, inMutexMask_addr);
    }
    ...
    public static void internal_native_LockWrite__0(long this_addr, long inMutexMask_addr) {
        jolt.physics.body.natives.JNI_BodyLockInterface.internal_native_LockWrite__0(this_addr, inMutexMask_addr);
    }
    ...
    public static void internal_native_UnlockWrite__0(long this_addr, long inMutexMask_addr) {
        jolt.physics.body.natives.JNI_BodyLockInterface.internal_native_UnlockWrite__0(this_addr, inMutexMask_addr);
    }
}
