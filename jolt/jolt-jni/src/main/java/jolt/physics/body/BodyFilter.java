...
public class BodyFilter extends NativeObject {
    ...
    public static void internal_native_deleteNative(long this_addr) {
        jolt.physics.body.natives.JNI_BodyFilter.internal_native_deleteNative(this_addr);
    }
    ...
    public static long internal_native_create_addr() {
        return jolt.physics.body.natives.JNI_BodyFilter.internal_native_create_addr();
    }
