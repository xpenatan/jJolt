...
public class TwoBodyConstraint extends Constraint {
    ...
    public static long internal_native_GetBody1_addr(long this_addr) {
        return jolt.physics.constraints.natives.JNI_TwoBodyConstraint.internal_native_GetBody1_addr(this_addr);
    }
    ...
    public static long internal_native_GetBody2_addr(long this_addr) {
        return jolt.physics.constraints.natives.JNI_TwoBodyConstraint.internal_native_GetBody2_addr(this_addr);
    }
    ...
    public static long internal_native_GetConstraintToBody1Matrix_addr(long this_addr) {
        return jolt.physics.constraints.natives.JNI_TwoBodyConstraint.internal_native_GetConstraintToBody1Matrix_addr(this_addr);
    }
    ...
    public static long internal_native_GetConstraintToBody2Matrix_addr(long this_addr) {
        return jolt.physics.constraints.natives.JNI_TwoBodyConstraint.internal_native_GetConstraintToBody2Matrix_addr(this_addr);
    }
}
