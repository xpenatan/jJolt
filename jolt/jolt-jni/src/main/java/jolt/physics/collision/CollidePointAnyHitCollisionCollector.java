...
public class CollidePointAnyHitCollisionCollector extends CollidePointCollector {
    ...
    public static long internal_native_create_addr() {
        return jolt.physics.collision.natives.JNI_CollidePointAnyHitCollisionCollector.internal_native_create_addr();
    }
    ...
    public static void internal_native_deleteNative(long this_addr) {
        jolt.physics.collision.natives.JNI_CollidePointAnyHitCollisionCollector.internal_native_deleteNative(this_addr);
    }
    ...
    public static boolean internal_native_HadHit(long this_addr) {
        return jolt.physics.collision.natives.JNI_CollidePointAnyHitCollisionCollector.internal_native_HadHit(this_addr);
    }
    ...
    public static long internal_native_get_mHit_addr(long this_addr) {
        return jolt.physics.collision.natives.JNI_CollidePointAnyHitCollisionCollector.internal_native_get_mHit_addr(this_addr);
    }
    ...
    public static void internal_native_set_mHit(long this_addr, long mHit_addr) {
        jolt.physics.collision.natives.JNI_CollidePointAnyHitCollisionCollector.internal_native_set_mHit(this_addr, mHit_addr);
    }
}
