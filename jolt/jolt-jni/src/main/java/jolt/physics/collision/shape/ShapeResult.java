...
public class ShapeResult extends NativeObject {
    ...
    public static void internal_native_deleteNative(long this_addr) {
        jolt.physics.collision.shape.natives.JNI_ShapeResult.internal_native_deleteNative(this_addr);
    }
    ...
    public static boolean internal_native_IsValid(long this_addr) {
        return jolt.physics.collision.shape.natives.JNI_ShapeResult.internal_native_IsValid(this_addr);
    }
    ...
    public static boolean internal_native_HasError(long this_addr) {
        return jolt.physics.collision.shape.natives.JNI_ShapeResult.internal_native_HasError(this_addr);
    }
    ...
    public static long internal_native_GetError_addr(long this_addr) {
        return jolt.physics.collision.shape.natives.JNI_ShapeResult.internal_native_GetError_addr(this_addr);
    }
    ...
    public static long internal_native_Get_addr(long this_addr) {
        return jolt.physics.collision.shape.natives.JNI_ShapeResult.internal_native_Get_addr(this_addr);
    }
    ...
    public static void internal_native_Clear(long this_addr) {
        jolt.physics.collision.shape.natives.JNI_ShapeResult.internal_native_Clear(this_addr);
    }
}
