...
public class TempAllocatorImpl extends TempAllocator {
    ...
    public static long internal_native_create_int_addr(int size) {
        return jolt.core.natives.JNI_TempAllocatorImpl.internal_native_create_int_addr(size);
    }
    ...
    public static void internal_native_deleteNative(long this_addr) {
        jolt.core.natives.JNI_TempAllocatorImpl.internal_native_deleteNative(this_addr);
    }
}
