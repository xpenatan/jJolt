...
val windowsFile = nativeFile("$libDir/jolt-build/build/c++/libs/windows/vc/jni/jolt64.dll",
        "$libDir/jolt-build/build/c++/libs/windows/vc/jolt64.dll")
val linuxFile = nativeFile("$libDir/jolt-build/build/c++/libs/linux/jni/libjolt64.so",
        "$libDir/jolt-build/build/c++/libs/linux/libjolt64.so")
val macArmFile = nativeFile("$libDir/jolt-build/build/c++/libs/mac/arm/jni/libjoltarm64.dylib",
        "$libDir/jolt-build/build/c++/libs/mac/arm/libjoltarm64.dylib")
val macFile = nativeFile("$libDir/jolt-build/build/c++/libs/mac/jni/libjolt64.dylib",
