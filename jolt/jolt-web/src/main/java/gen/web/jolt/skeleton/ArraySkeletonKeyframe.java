...
public class ArraySkeletonKeyframe extends NativeObject {
    ...
    @org.teavm.jso.JSBody(params = {"this_addr"}, script = "var jsObj = jolt.wrapPointer(this_addr, jolt.ArraySkeletonKeyframe);jolt.destroy(jsObj);")
    ...
    @org.teavm.jso.JSBody(params = {"this_addr"}, script = "var jsObj = jolt.wrapPointer(this_addr, jolt.ArraySkeletonKeyframe);var returnedJSObj = jsObj.empty();return returnedJSObj;")
    ...
    @org.teavm.jso.JSBody(params = {"this_addr"}, script = "var jsObj = jolt.wrapPointer(this_addr, jolt.ArraySkeletonKeyframe);var returnedJSObj = jsObj.size();return returnedJSObj;")
    ...
    @org.teavm.jso.JSBody(params = {"this_addr", "inValue_addr"}, script = "var jsObj = jolt.wrapPointer(this_addr, jolt.ArraySkeletonKeyframe);jsObj.push_back(inValue_addr);")
    ...
    @org.teavm.jso.JSBody(params = {"this_addr", "inSize"}, script = "var jsObj = jolt.wrapPointer(this_addr, jolt.ArraySkeletonKeyframe);jsObj.reserve(inSize);")
    ...
    @org.teavm.jso.JSBody(params = {"this_addr", "inSize"}, script = "var jsObj = jolt.wrapPointer(this_addr, jolt.ArraySkeletonKeyframe);jsObj.resize(inSize);")
    ...
    @org.teavm.jso.JSBody(params = {"this_addr"}, script = "var jsObj = jolt.wrapPointer(this_addr, jolt.ArraySkeletonKeyframe);jsObj.clear();")
