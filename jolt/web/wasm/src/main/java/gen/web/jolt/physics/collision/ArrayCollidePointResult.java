...
public class ArrayCollidePointResult extends NativeObject {
    ...
    @org.teavm.jso.JSBody(script = "var jsObj = new jolt.ArrayCollidePointResult();return jolt.getPointer(jsObj);")
    ...
    @org.teavm.jso.JSBody(params = {"this_addr"}, script = "var jsObj = jolt.wrapPointer(this_addr, jolt.ArrayCollidePointResult);jolt.destroy(jsObj);")
    ...
    @org.teavm.jso.JSBody(params = {"this_addr"}, script = "var jsObj = jolt.wrapPointer(this_addr, jolt.ArrayCollidePointResult);var returnedJSObj = jsObj.empty();return returnedJSObj;")
    ...
    @org.teavm.jso.JSBody(params = {"this_addr"}, script = "var jsObj = jolt.wrapPointer(this_addr, jolt.ArrayCollidePointResult);var returnedJSObj = jsObj.size();return returnedJSObj;")
    ...
    @org.teavm.jso.JSBody(params = {"this_addr", "inIndex"}, script = "var jsObj = jolt.wrapPointer(this_addr, jolt.ArrayCollidePointResult);var returnedJSObj = jsObj.at(inIndex);if(!returnedJSObj.hasOwnProperty('ptr')) return 0; return jolt.getPointer(returnedJSObj);")
    ...
    @org.teavm.jso.JSBody(params = {"this_addr", "inValue_addr"}, script = "var jsObj = jolt.wrapPointer(this_addr, jolt.ArrayCollidePointResult);jsObj.push_back(inValue_addr);")
    ...
    @org.teavm.jso.JSBody(params = {"this_addr", "inSize"}, script = "var jsObj = jolt.wrapPointer(this_addr, jolt.ArrayCollidePointResult);jsObj.reserve(inSize);")
    ...
    @org.teavm.jso.JSBody(params = {"this_addr", "inSize"}, script = "var jsObj = jolt.wrapPointer(this_addr, jolt.ArrayCollidePointResult);jsObj.resize(inSize);")
    ...
    @org.teavm.jso.JSBody(params = {"this_addr"}, script = "var jsObj = jolt.wrapPointer(this_addr, jolt.ArrayCollidePointResult);jsObj.clear();")
