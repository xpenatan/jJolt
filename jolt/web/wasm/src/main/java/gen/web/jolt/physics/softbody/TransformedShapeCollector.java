...
public class TransformedShapeCollector extends NativeObject {
    ...
    @org.teavm.jso.JSBody(params = {"this_addr"}, script = "var jsObj = jolt.wrapPointer(this_addr, jolt.TransformedShapeCollectorJS);jolt.destroy(jsObj);")
    ...
    @org.teavm.jso.JSBody(params = {"this_addr"}, script = "var jsObj = jolt.wrapPointer(this_addr, jolt.TransformedShapeCollector);jsObj.ResetNative();")
    ...
    @org.teavm.jso.JSBody(params = {"this_addr", "inContext_addr"}, script = "var jsObj = jolt.wrapPointer(this_addr, jolt.TransformedShapeCollector);jsObj.SetContext(inContext_addr);")
    ...
    @org.teavm.jso.JSBody(params = {"this_addr"}, script = "var jsObj = jolt.wrapPointer(this_addr, jolt.TransformedShapeCollector);var returnedJSObj = jsObj.GetContext();if(!returnedJSObj.hasOwnProperty('ptr')) return 0; return jolt.getPointer(returnedJSObj);")
    ...
    @org.teavm.jso.JSBody(params = {"this_addr", "inFraction"}, script = "var jsObj = jolt.wrapPointer(this_addr, jolt.TransformedShapeCollector);jsObj.UpdateEarlyOutFraction(inFraction);")
    ...
    @org.teavm.jso.JSBody(params = {"this_addr", "inFraction"}, script = "var jsObj = jolt.wrapPointer(this_addr, jolt.TransformedShapeCollector);jsObj.ResetEarlyOutFraction(inFraction);")
    ...
    @org.teavm.jso.JSBody(params = {"this_addr"}, script = "var jsObj = jolt.wrapPointer(this_addr, jolt.TransformedShapeCollector);jsObj.ResetEarlyOutFraction();")
    ...
    @org.teavm.jso.JSBody(params = {"this_addr"}, script = "var jsObj = jolt.wrapPointer(this_addr, jolt.TransformedShapeCollector);jsObj.ForceEarlyOut();")
    ...
    @org.teavm.jso.JSBody(params = {"this_addr"}, script = "var jsObj = jolt.wrapPointer(this_addr, jolt.TransformedShapeCollector);var returnedJSObj = jsObj.ShouldEarlyOut();return returnedJSObj;")
    ...
    @org.teavm.jso.JSBody(params = {"this_addr"}, script = "var jsObj = jolt.wrapPointer(this_addr, jolt.TransformedShapeCollector);var returnedJSObj = jsObj.GetEarlyOutFraction();return returnedJSObj;")
    ...
    @org.teavm.jso.JSBody(params = {"this_addr"}, script = "var jsObj = jolt.wrapPointer(this_addr, jolt.TransformedShapeCollector);var returnedJSObj = jsObj.GetPositiveEarlyOutFraction();return returnedJSObj;")
    ...
    @org.teavm.jso.JSBody(script = "var jsObj = new jolt.TransformedShapeCollectorJS();return jolt.getPointer(jsObj);")
    public static native int internal_native_create_addr();

    @org.teavm.jso.JSBody(params = { "this_addr", "Reset", "OnBody", "AddHit" }, script = "var TransformedShapeCollectorJS = jolt.wrapPointer(this_addr, jolt.TransformedShapeCollectorJS); TransformedShapeCollectorJS.Reset = Reset; TransformedShapeCollectorJS.OnBody = OnBody; TransformedShapeCollectorJS.AddHit = AddHit;")
