...
import gen.web.jolt.physics.collision.CollidePointResult;
...
public class CollidePointCollector extends NativeObject {
    ...
    @org.teavm.jso.JSBody(params = {"this_addr"}, script = "var jsObj = jolt.wrapPointer(this_addr, jolt.CollidePointCollector);jsObj.ResetNative();")
