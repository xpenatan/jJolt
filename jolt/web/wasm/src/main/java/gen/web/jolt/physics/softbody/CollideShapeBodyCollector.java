...
public class CollideShapeBodyCollector extends NativeObject {
    ...
    @org.teavm.jso.JSBody(params = {"this_addr"}, script = "var jsObj = jolt.wrapPointer(this_addr, jolt.CollideShapeBodyCollectorJS);jolt.destroy(jsObj);")
    ...
    @org.teavm.jso.JSBody(params = {"this_addr"}, script = "var jsObj = jolt.wrapPointer(this_addr, jolt.CollideShapeBodyCollector);jsObj.ResetNative();")
    ...
    @org.teavm.jso.JSBody(params = {"this_addr", "inContext_addr"}, script = "var jsObj = jolt.wrapPointer(this_addr, jolt.CollideShapeBodyCollector);jsObj.SetContext(inContext_addr);")
    ...
    @org.teavm.jso.JSBody(params = {"this_addr"}, script = "var jsObj = jolt.wrapPointer(this_addr, jolt.CollideShapeBodyCollector);var returnedJSObj = jsObj.GetContext();if(!returnedJSObj.hasOwnProperty('ptr')) return 0; return jolt.getPointer(returnedJSObj);")
    ...
    @org.teavm.jso.JSBody(params = {"this_addr", "inFraction"}, script = "var jsObj = jolt.wrapPointer(this_addr, jolt.CollideShapeBodyCollector);jsObj.UpdateEarlyOutFraction(inFraction);")
    ...
    @org.teavm.jso.JSBody(params = {"this_addr", "inFraction"}, script = "var jsObj = jolt.wrapPointer(this_addr, jolt.CollideShapeBodyCollector);jsObj.ResetEarlyOutFraction(inFraction);")
    ...
    @org.teavm.jso.JSBody(params = {"this_addr"}, script = "var jsObj = jolt.wrapPointer(this_addr, jolt.CollideShapeBodyCollector);jsObj.ResetEarlyOutFraction();")
    ...
    @org.teavm.jso.JSBody(params = {"this_addr"}, script = "var jsObj = jolt.wrapPointer(this_addr, jolt.CollideShapeBodyCollector);jsObj.ForceEarlyOut();")
    ...
    @org.teavm.jso.JSBody(params = {"this_addr"}, script = "var jsObj = jolt.wrapPointer(this_addr, jolt.CollideShapeBodyCollector);var returnedJSObj = jsObj.ShouldEarlyOut();return returnedJSObj;")
    ...
    @org.teavm.jso.JSBody(params = {"this_addr"}, script = "var jsObj = jolt.wrapPointer(this_addr, jolt.CollideShapeBodyCollector);var returnedJSObj = jsObj.GetEarlyOutFraction();return returnedJSObj;")
    ...
    @org.teavm.jso.JSBody(params = {"this_addr"}, script = "var jsObj = jolt.wrapPointer(this_addr, jolt.CollideShapeBodyCollector);var returnedJSObj = jsObj.GetPositiveEarlyOutFraction();return returnedJSObj;")
    ...
    @org.teavm.jso.JSBody(script = "var jsObj = new jolt.CollideShapeBodyCollectorJS();return jolt.getPointer(jsObj);")
    public static native int internal_native_create_addr();

    @org.teavm.jso.JSBody(params = { "this_addr", "Reset", "AddHit" }, script = "var CollideShapeBodyCollectorJS = jolt.wrapPointer(this_addr, jolt.CollideShapeBodyCollectorJS); CollideShapeBodyCollectorJS.Reset = Reset; CollideShapeBodyCollectorJS.AddHit = AddHit;")
