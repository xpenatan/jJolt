...
import gen.c.jolt.physics.collision.CollidePointResult;
...
public class CollidePointCollector extends NativeObject {
    ...
    private static final java.util.ArrayList<CollidePointCollector> TEAVMC_CALLBACKS = new java.util.ArrayList<>();
    ...
    @org.teavm.interop.Export(name = "teavmc_CollidePointCollector_Reset")
    private static void teavmc_CollidePointCollector_Reset(int callbackId) {
    ...
    @org.teavm.interop.Export(name = "teavmc_CollidePointCollector_OnBody")
    private static void teavmc_CollidePointCollector_OnBody(int callbackId, long inBody_addr) {
    ...
    @org.teavm.interop.Export(name = "teavmc_CollidePointCollector_AddHit")
    private static void teavmc_CollidePointCollector_AddHit(int callbackId, long inResult_addr) {
        TEAVMC_CALLBACKS.get(callbackId).internal_AddHit(inResult_addr);
    }

    @org.teavm.interop.Import(name = "teavmc_CollidePointCollector_setupCallback")
    ...
    @org.teavm.interop.Import(name = "jolt_physics_softbody_collidepointcollector_deletenative")
    ...
    @org.teavm.interop.Import(name = "jolt_physics_softbody_collidepointcollector_resetnative")
    ...
    @org.teavm.interop.Import(name = "jolt_physics_softbody_collidepointcollector_setcontext")
    ...
    @org.teavm.interop.Import(name = "jolt_physics_softbody_collidepointcollector_getcontext_addr")
    ...
    @org.teavm.interop.Import(name = "jolt_physics_softbody_collidepointcollector_updateearlyoutfraction")
    ...
    @org.teavm.interop.Import(name = "jolt_physics_softbody_collidepointcollector_resetearlyoutfraction_l_f")
    ...
    @org.teavm.interop.Import(name = "jolt_physics_softbody_collidepointcollector_resetearlyoutfraction_l")
    ...
    @org.teavm.interop.Import(name = "jolt_physics_softbody_collidepointcollector_forceearlyout")
    ...
    @org.teavm.interop.Import(name = "jolt_physics_softbody_collidepointcollector_shouldearlyout")
    ...
    @org.teavm.interop.Import(name = "jolt_physics_softbody_collidepointcollector_getearlyoutfraction")
    ...
    @org.teavm.interop.Import(name = "jolt_physics_softbody_collidepointcollector_getpositiveearlyoutfraction")
    ...
    private void setupCallback() {
        ...
        setupCallback(native_address, callbackId, org.teavm.interop.Function.get(TEAVMC_Reset_Function.class, CollidePointCollector.class, "teavmc_CollidePointCollector_Reset"), org.teavm.interop.Function.get(TEAVMC_OnBody_Function.class, CollidePointCollector.class, "teavmc_CollidePointCollector_OnBody"), org.teavm.interop.Function.get(TEAVMC_AddHit_Function.class, CollidePointCollector.class, "teavmc_CollidePointCollector_AddHit"));
    }
    ...
    @org.teavm.interop.Import(name = "jolt_physics_softbody_collidepointcollector_create_addr")
