...
public class CastShapeCollector extends NativeObject {
    ...
    private static final java.util.ArrayList<CastShapeCollector> TEAVMC_CALLBACKS = new java.util.ArrayList<>();
    ...
    @org.teavm.interop.Export(name = "teavmc_CastShapeCollector_Reset")
    private static void teavmc_CastShapeCollector_Reset(int callbackId) {
    ...
    @org.teavm.interop.Export(name = "teavmc_CastShapeCollector_OnBody")
    private static void teavmc_CastShapeCollector_OnBody(int callbackId, long inBody_addr) {
    ...
    @org.teavm.interop.Export(name = "teavmc_CastShapeCollector_AddHit")
    private static void teavmc_CastShapeCollector_AddHit(int callbackId, long inResult_addr) {
        TEAVMC_CALLBACKS.get(callbackId).internal_AddHit(inResult_addr);
    }

    @org.teavm.interop.Import(name = "teavmc_CastShapeCollector_setupCallback")
    ...
    @org.teavm.interop.Import(name = "jolt_physics_softbody_castshapecollector_setcontext")
    ...
    @org.teavm.interop.Import(name = "jolt_physics_softbody_castshapecollector_getcontext_addr")
    ...
    @org.teavm.interop.Import(name = "jolt_physics_softbody_castshapecollector_updateearlyoutfraction")
    ...
    @org.teavm.interop.Import(name = "jolt_physics_softbody_castshapecollector_resetearlyoutfraction_l_f")
    ...
    @org.teavm.interop.Import(name = "jolt_physics_softbody_castshapecollector_resetearlyoutfraction_l")
    ...
    @org.teavm.interop.Import(name = "jolt_physics_softbody_castshapecollector_forceearlyout")
    ...
    @org.teavm.interop.Import(name = "jolt_physics_softbody_castshapecollector_shouldearlyout")
    ...
    @org.teavm.interop.Import(name = "jolt_physics_softbody_castshapecollector_getearlyoutfraction")
    ...
    @org.teavm.interop.Import(name = "jolt_physics_softbody_castshapecollector_getpositiveearlyoutfraction")
    ...
    private void setupCallback() {
        ...
        setupCallback(native_address, callbackId, org.teavm.interop.Function.get(TEAVMC_Reset_Function.class, CastShapeCollector.class, "teavmc_CastShapeCollector_Reset"), org.teavm.interop.Function.get(TEAVMC_OnBody_Function.class, CastShapeCollector.class, "teavmc_CastShapeCollector_OnBody"), org.teavm.interop.Function.get(TEAVMC_AddHit_Function.class, CastShapeCollector.class, "teavmc_CastShapeCollector_AddHit"));
    }
    ...
    @org.teavm.interop.Import(name = "jolt_physics_softbody_castshapecollector_create_addr")
