...
public class CollideShapeCollector extends NativeObject {
    ...
    private static final java.util.ArrayList<CollideShapeCollector> TEAVMC_CALLBACKS = new java.util.ArrayList<>();
    ...
    @org.teavm.interop.Export(name = "teavmc_CollideShapeCollector_Reset")
    private static void teavmc_CollideShapeCollector_Reset(int callbackId) {
    ...
    @org.teavm.interop.Export(name = "teavmc_CollideShapeCollector_OnBody")
    private static void teavmc_CollideShapeCollector_OnBody(int callbackId, long inBody_addr) {
    ...
    @org.teavm.interop.Export(name = "teavmc_CollideShapeCollector_AddHit")
    private static void teavmc_CollideShapeCollector_AddHit(int callbackId, long inResult_addr) {
        TEAVMC_CALLBACKS.get(callbackId).internal_AddHit(inResult_addr);
    }

    @org.teavm.interop.Import(name = "teavmc_CollideShapeCollector_setupCallback")
    ...
    @org.teavm.interop.Import(name = "jolt_physics_softbody_collideshapecollector_deletenative")
    ...
    @org.teavm.interop.Import(name = "jolt_physics_softbody_collideshapecollector_resetnative")
    ...
    @org.teavm.interop.Import(name = "jolt_physics_softbody_collideshapecollector_setcontext")
    ...
    @org.teavm.interop.Import(name = "jolt_physics_softbody_collideshapecollector_getcontext_addr")
    ...
    @org.teavm.interop.Import(name = "jolt_physics_softbody_collideshapecollector_updateearlyoutfraction")
    ...
    @org.teavm.interop.Import(name = "jolt_physics_softbody_collideshapecollector_resetearlyoutfraction_l_f")
    ...
    @org.teavm.interop.Import(name = "jolt_physics_softbody_collideshapecollector_resetearlyoutfraction_l")
    ...
    @org.teavm.interop.Import(name = "jolt_physics_softbody_collideshapecollector_forceearlyout")
    ...
    @org.teavm.interop.Import(name = "jolt_physics_softbody_collideshapecollector_shouldearlyout")
    ...
    @org.teavm.interop.Import(name = "jolt_physics_softbody_collideshapecollector_getearlyoutfraction")
    ...
    @org.teavm.interop.Import(name = "jolt_physics_softbody_collideshapecollector_getpositiveearlyoutfraction")
    ...
    private void setupCallback() {
        ...
        setupCallback(native_address, callbackId, org.teavm.interop.Function.get(TEAVMC_Reset_Function.class, CollideShapeCollector.class, "teavmc_CollideShapeCollector_Reset"), org.teavm.interop.Function.get(TEAVMC_OnBody_Function.class, CollideShapeCollector.class, "teavmc_CollideShapeCollector_OnBody"), org.teavm.interop.Function.get(TEAVMC_AddHit_Function.class, CollideShapeCollector.class, "teavmc_CollideShapeCollector_AddHit"));
    }
    ...
    @org.teavm.interop.Import(name = "jolt_physics_softbody_collideshapecollector_create_addr")
