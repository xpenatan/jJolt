...
public class OrientedBox extends NativeObject {
    ...
    public static long internal_native_create_addr() {
        return jolt.geometry.natives.JNI_OrientedBox.internal_native_create_addr();
    }
    ...
    public static long internal_native_create_Mat44_Vec3_addr(long inOrientation_addr, long inHalfExtents_addr) {
        return jolt.geometry.natives.JNI_OrientedBox.internal_native_create_Mat44_Vec3_addr(inOrientation_addr, inHalfExtents_addr);
    }
    ...
    public static long internal_native_get_mOrientation_addr(long this_addr) {
        return jolt.geometry.natives.JNI_OrientedBox.internal_native_get_mOrientation_addr(this_addr);
    }
    ...
    public static void internal_native_set_mOrientation(long this_addr, long mOrientation_addr) {
        jolt.geometry.natives.JNI_OrientedBox.internal_native_set_mOrientation(this_addr, mOrientation_addr);
    }
    ...
    public static long internal_native_get_mHalfExtents_addr(long this_addr) {
        return jolt.geometry.natives.JNI_OrientedBox.internal_native_get_mHalfExtents_addr(this_addr);
    }
    ...
    public static void internal_native_set_mHalfExtents(long this_addr, long mHalfExtents_addr) {
        jolt.geometry.natives.JNI_OrientedBox.internal_native_set_mHalfExtents(this_addr, mHalfExtents_addr);
    }
}
