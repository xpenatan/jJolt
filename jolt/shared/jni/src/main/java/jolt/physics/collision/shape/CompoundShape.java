...
public class CompoundShape extends Shape {
    ...
    public static int internal_native_GetNumSubShapes(long this_addr) {
        return jolt.physics.collision.shape.natives.JNI_CompoundShape.internal_native_GetNumSubShapes(this_addr);
    }
    ...
    public static long internal_native_GetSubShape_addr(long this_addr, int inIdx) {
        return jolt.physics.collision.shape.natives.JNI_CompoundShape.internal_native_GetSubShape_addr(this_addr, inIdx);
    }
}
