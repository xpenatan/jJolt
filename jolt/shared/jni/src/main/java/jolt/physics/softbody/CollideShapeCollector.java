...
public class CollideShapeCollector extends NativeObject {
    ...
    public static void internal_native_deleteNative(long this_addr) {
        jolt.physics.softbody.natives.JNI_CollideShapeCollector.internal_native_deleteNative(this_addr);
    }
    ...
    public static void internal_native_ResetNative(long this_addr) {
        jolt.physics.softbody.natives.JNI_CollideShapeCollector.internal_native_ResetNative(this_addr);
    }
    ...
    public static void internal_native_SetContext(long this_addr, long inContext_addr) {
        jolt.physics.softbody.natives.JNI_CollideShapeCollector.internal_native_SetContext(this_addr, inContext_addr);
    }
    ...
    public static long internal_native_GetContext_addr(long this_addr) {
        return jolt.physics.softbody.natives.JNI_CollideShapeCollector.internal_native_GetContext_addr(this_addr);
    }
    ...
    public static void internal_native_UpdateEarlyOutFraction(long this_addr, float inFraction) {
        jolt.physics.softbody.natives.JNI_CollideShapeCollector.internal_native_UpdateEarlyOutFraction(this_addr, inFraction);
    }
    ...
    public static void internal_native_ResetEarlyOutFraction(long this_addr, float inFraction) {
        jolt.physics.softbody.natives.JNI_CollideShapeCollector.internal_native_ResetEarlyOutFraction(this_addr, inFraction);
    }
    ...
    public static void internal_native_ResetEarlyOutFraction(long this_addr) {
        jolt.physics.softbody.natives.JNI_CollideShapeCollector.internal_native_ResetEarlyOutFraction(this_addr);
    }
    ...
    public static void internal_native_ForceEarlyOut(long this_addr) {
        jolt.physics.softbody.natives.JNI_CollideShapeCollector.internal_native_ForceEarlyOut(this_addr);
    }
    ...
    public static boolean internal_native_ShouldEarlyOut(long this_addr) {
        return jolt.physics.softbody.natives.JNI_CollideShapeCollector.internal_native_ShouldEarlyOut(this_addr);
    }
    ...
    public static float internal_native_GetEarlyOutFraction(long this_addr) {
        return jolt.physics.softbody.natives.JNI_CollideShapeCollector.internal_native_GetEarlyOutFraction(this_addr);
    }
    ...
    public static float internal_native_GetPositiveEarlyOutFraction(long this_addr) {
        return jolt.physics.softbody.natives.JNI_CollideShapeCollector.internal_native_GetPositiveEarlyOutFraction(this_addr);
    }
    ...
    public static long internal_native_create_addr() {
        return jolt.physics.softbody.natives.JNI_CollideShapeCollector.internal_native_create_addr();
    }
