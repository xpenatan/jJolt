...
public class RotatedTranslatedShape extends DecoratedShape {
    ...
    public static long internal_native_GetRotation_addr(long this_addr) {
        return jolt.physics.collision.shape.natives.JNI_RotatedTranslatedShape.internal_native_GetRotation_addr(this_addr);
    }
    ...
    public static long internal_native_GetPosition_addr(long this_addr) {
        return jolt.physics.collision.shape.natives.JNI_RotatedTranslatedShape.internal_native_GetPosition_addr(this_addr);
    }
}
