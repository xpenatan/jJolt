...
public class ConvexShapeSettings extends ShapeSettings {
    ...
    public static long internal_native_get_mMaterial_addr(long this_addr) {
        return jolt.physics.collision.shape.natives.JNI_ConvexShapeSettings.internal_native_get_mMaterial_addr(this_addr);
    }
    ...
    public static void internal_native_set_mMaterial(long this_addr, long mMaterial_addr) {
        jolt.physics.collision.shape.natives.JNI_ConvexShapeSettings.internal_native_set_mMaterial(this_addr, mMaterial_addr);
    }
    ...
    public static float internal_native_get_mDensity(long this_addr) {
        return jolt.physics.collision.shape.natives.JNI_ConvexShapeSettings.internal_native_get_mDensity(this_addr);
    }
    ...
    public static void internal_native_set_mDensity(long this_addr, float mDensity) {
        jolt.physics.collision.shape.natives.JNI_ConvexShapeSettings.internal_native_set_mDensity(this_addr, mDensity);
    }
}
