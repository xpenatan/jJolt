...
public class ArraySoftBodySharedSettingsVertexAttributes extends NativeObject {
    ...
    public static long internal_native_create_addr() {
        return jolt.physics.softbody.natives.JNI_ArraySoftBodySharedSettingsVertexAttributes.internal_native_create_addr();
    }
    ...
    public static void internal_native_deleteNative(long this_addr) {
        jolt.physics.softbody.natives.JNI_ArraySoftBodySharedSettingsVertexAttributes.internal_native_deleteNative(this_addr);
    }
    ...
    public static boolean internal_native_empty(long this_addr) {
        return jolt.physics.softbody.natives.JNI_ArraySoftBodySharedSettingsVertexAttributes.internal_native_empty(this_addr);
    }
    ...
    public static int internal_native_size(long this_addr) {
        return jolt.physics.softbody.natives.JNI_ArraySoftBodySharedSettingsVertexAttributes.internal_native_size(this_addr);
    }
    ...
    public static long internal_native_at_addr(long this_addr, int inIndex) {
        return jolt.physics.softbody.natives.JNI_ArraySoftBodySharedSettingsVertexAttributes.internal_native_at_addr(this_addr, inIndex);
    }
    ...
    public static void internal_native_push_back(long this_addr, long inValue_addr) {
        jolt.physics.softbody.natives.JNI_ArraySoftBodySharedSettingsVertexAttributes.internal_native_push_back(this_addr, inValue_addr);
    }
    ...
    public static void internal_native_reserve(long this_addr, int inSize) {
        jolt.physics.softbody.natives.JNI_ArraySoftBodySharedSettingsVertexAttributes.internal_native_reserve(this_addr, inSize);
    }
    ...
    public static void internal_native_resize(long this_addr, int inSize) {
        jolt.physics.softbody.natives.JNI_ArraySoftBodySharedSettingsVertexAttributes.internal_native_resize(this_addr, inSize);
    }
    ...
    public static void internal_native_clear(long this_addr) {
        jolt.physics.softbody.natives.JNI_ArraySoftBodySharedSettingsVertexAttributes.internal_native_clear(this_addr);
    }
    ...
    public static long internal_native_data_addr(long this_addr) {
        return jolt.physics.softbody.natives.JNI_ArraySoftBodySharedSettingsVertexAttributes.internal_native_data_addr(this_addr);
    }
}
