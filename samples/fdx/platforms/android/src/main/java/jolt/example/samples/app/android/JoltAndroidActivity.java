...
public class JoltAndroidActivity extends AndroidApplicationActivity {
    ...
    protected AndroidApplicationConfig createApplicationConfig() {
        return new AndroidApplicationConfig()
                .title("jJolt libfdx - Android " + graphicsDisplayName())
                .size(960, 540)
                .vSync(true)
                .foregroundFps(60)
    ...
    protected ApplicationListener createApplicationListener() {
        return new JoltSampleApplication(exitAfterFrames(), debugEnabled());
    }
    ...
    private long exitAfterFrames() {
        ...
        String value = intent != null ? intent.getStringExtra("jjolt.sample.exitAfterFrames") : null;
    ...
    private boolean debugEnabled() {
        Intent intent = getIntent();
        String value = intent != null ? intent.getStringExtra("jjolt.sample.debug") : null;
        if (value == null || value.trim().isEmpty()) {
            return true;
        }
